...
Arlington <- BIEN_occurrence_county(country="United States", state="Virginia", county = "Arlington")
head(Arlington)
tail(Arlington)
Fairfax <- BIEN_occurrence_county(country="United States", state="Virginia", county = "Fairfax")
head(Fairfax)
tail(Fairfax)
attributes(Fairfax)
Amherst <- BIEN_occurrence_county(country="United States", state="Virginia", county = "Amherst")
head(Amherst)
tail(Amherst)
attributes(Amherst)
```
...
Arlington.occ=Arlington[c(1)]
head(Arlington.occ)
Fairfax.occ=Fairfax[c(1)]
head(Fairfax.occ)
Amherst.occ=Amherst[c(1)]
head(Amherst.occ)
#These are now two species occurrence lists, one for The Arlington, one for Fairfax
#To turn them into species lists with abundance data, you can recycle the code from above.
Arlington.ab=count(Arlington.occ)
head(Arlington.ab)
Fairfax.ab=count(Fairfax.occ)
head(Fairfax.ab)
Amherst.ab=count(Amherst.occ)
head(Amherst.ab)
#Then re-name the columns as previously. Here just the Arlington
Arlington.ab=data.frame("Arlington", Arlington.ab)
head(Arlington.ab)
names(Arlington.ab)<-c("ListID", "SpeciesID", "Freq")
head(Arlington.ab)
Fairfax.ab=data.frame("Fairfax", Fairfax.ab)
head(Fairfax.ab)
names(Fairfax.ab)<-c("ListID", "SpeciesID", "Freq")
head(Fairfax.ab)
Amherst.ab=data.frame("Amherst", Amherst.ab)
head(Amherst.ab)
names(Amherst.ab)<-c("ListID", "SpeciesID", "Freq")
head(Amherst.ab)
threecounty.ab=rbind(Arlington.ab, Fairfax.ab, Amherst.ab)
head(threecounty.ab)
tail(threecounty.ab)
dim(threecounty.ab)
...
Cannot come up with the indicies because it says the function is not available
